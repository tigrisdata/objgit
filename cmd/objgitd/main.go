...
func main() {
	...
	// forever (see internal/s3fs/resilient.go). sysFS (the SSH host key
	// and webhook settings) and the LFS store use this client;
	// internal/storage/tigris dials its own.
